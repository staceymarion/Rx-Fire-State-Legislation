...
var attrcol = {
    Acres_2017: {1: "#A9DFBF", 2: "#7DCEA0", 3: "#27AE60", 4: "#1E8449", 5: "#145A32"},
    Acres_2018: {1: "#A9DFBF", 2: "#7DCEA0", 3: "#27AE60", 4: "#1E8449", 5: "#145A32"}, 
    Acres_2019: {1: "#A9DFBF", 2: "#7DCEA0", 3: "#27AE60", 4: "#1E8449", 5: "#145A32"}, 
    BurnProgra: {"Yes": "#145A32", "No": "#A9DFBF"},
    FireCounci: {"Yes": "#27AE60", "No": "#A9DFBF", "Regional":"#145A32"},
    LiabilityL: {1:"#7DCEA0", 2:"#27AE60", 3:"#145A32", 4:"#A9DFBF" },
    PermitFee: {"N/A":"#D0D3D4", "Not Required":"#1E8449", "Sometimes":"#27AE60", "Required":"#145A32"}, 
    PermitRequ: {"Required":"#A9DFBF", "Not Required":"#145A32"},
    Time4Permi: {1:"#D0D3D4", 2:"#145A32", 3:"#27AE60"},
    Trend_2017: {"Down":"#A9DFBF", "Same":"#27AE60", "Up":"#145A32"}, 
    Trend_2018: {"Down":"#A9DFBF", "Same":"#27AE60", "Up":"#145A32"}, 
    Trend_2019: {"Down":"#A9DFBF", "Same":"#27AE60", "Up":"#145A32"},
...
function createLegend(expressed) {
    ...
    if (expressed == "Acres_2017") {  
        svg.append("circle").attr("cx", 10).attr("cy", 130).attr("r", 6).style("fill", "#A9DFBF");
        svg.append("circle").attr("cx", 10).attr("cy", 160).attr("r", 6).style("fill", "#7DCEA0");
        svg.append("circle").attr("cx", 10).attr("cy", 190).attr("r", 6).style("fill", "#27AE60");
        svg.append("circle").attr("cx", 10).attr("cy", 220).attr("r", 6).style("fill", "#1E8449");
        svg.append("circle").attr("cx", 10).attr("cy", 250).attr("r", 6).style("fill", "#145A32");
        ...
        svg.append("circle").attr("cx", 10).attr("cy", 160).attr("r", 6).style("fill", "#1E8449");
        svg.append("circle").attr("cx", 10).attr("cy", 190).attr("r", 6).style("fill", "#27AE60");
        svg.append("circle").attr("cx", 10).attr("cy", 220).attr("r", 6).style("fill", "#145A32");
        ...
        svg.append("circle").attr("cx", 10).attr("cy" ,130).attr("r", 6).style("fill", "#D0D3D4");
        svg.append("circle").attr("cx", 10).attr("cy", 160).attr("r", 6).style("fill", "#145A32");
        svg.append("circle").attr("cx", 10).attr("cy", 190).attr("r", 6).style("fill", "#27AE60");
        ...
        svg.append("circle").attr("cx", 10).attr("cy", 130).attr("r", 6).style("fill", "#145A32");
        svg.append("circle").attr("cx", 10).attr("cy", 160).attr("r", 6).style("fill", "#A9DFBF");
        ...
        svg.append("circle").attr("cx", 10).attr("cy", 130).attr("r", 6).style("fill", "#A9DFBF");
        svg.append("circle").attr("cx", 10).attr("cy", 160).attr("r", 6).style("fill", "#27AE60");
        svg.append("circle").attr("cx", 10).attr("cy", 190).attr("r", 6).style("fill", "#145A32");
        ...
        svg.append("circle").attr("cx", 10).attr("cy", 130).attr("r", 6).style("fill", "#7DCEA0");
        svg.append("circle").attr("cx", 10).attr("cy", 160).attr("r", 6).style("fill", "#27AE60");
        svg.append("circle").attr("cx", 10).attr("cy", 190).attr("r", 6).style("fill", "#145A32");
        svg.append("circle").attr("cx", 10).attr("cy", 220).attr("r", 6).style("fill", "#A9DFBF");
        ...
        svg.append("circle").attr("cx", 10).attr("cy", 130).attr("r", 6).style("fill", "#27AE60");
        svg.append("circle").attr("cx", 10).attr("cy", 160).attr("r", 6).style("fill", "#A9DFBF");
        svg.append("circle").attr("cx", 10).attr("cy", 190).attr("r", 6).style("fill", "#145A32");
