...
var attrcol = {
    Acres_2017: {1: "#EDF8E9", 2: "#BAE4B3", 3: "#74C476", 4: "#319450", 5: "#082E2E"},
    Acres_2018: {1: "#EDF8E9", 2: "#BAE4B3", 3: "#74C476", 4: "#319450", 5: "#082E2E"}, 
    Acres_2019: {1: "#EDF8E9", 2: "#BAE4B3", 3: "#74C476", 4: "#319450", 5: "#082E2E"}, 
    BurnProgra: {"Yes": "#082E2E", "No": "#EDF8E9"},
    FireCounci: {"Yes": "#74C476", "No": "#EDF8E9", "Regional":"#082E2E"},
    LiabilityL: {1:"#BAE4B3", 2:"#74C476", 3:"#082E2E", 4:"#EDF8E9" },
    PermitFee: {"N/A":"#D0D3D4", "Not Required":"#319450", "Sometimes":"#74C476", "Required":"#082E2E"}, 
    PermitRequ: {"Required":"#EDF8E9", "Not Required":"#082E2E"},
    Time4Permi: {1:"#D0D3D4", 2:"#082E2E", 3:"#74C476"},
    Trend_2017: {"Down":"#EDF8E9", "Same":"#74C476", "Up":"#082E2E"}, 
    Trend_2018: {"Down":"#EDF8E9", "Same":"#74C476", "Up":"#082E2E"}, 
    Trend_2019: {"Down":"#EDF8E9", "Same":"#74C476", "Up":"#082E2E"},
...
function setEnumerationUnits(americanStates, map, path) {
    var states = map.selectAll(".states")
        ...
        var desc = states.append("desc")
            .text('{"stroke": "black", "stroke-width": ".75px"}') // upon mouseover, style returns to stroke #ccc
};
...
function createLegend(expressed) {
    ...
    if (expressed == "Acres_2017") {  
        svg.append("circle").attr("cx", 10).attr("cy", 130).attr("r", 6).style("fill", "#EDF8E9");
        svg.append("circle").attr("cx", 10).attr("cy", 160).attr("r", 6).style("fill", "#BAE4B3");
        svg.append("circle").attr("cx", 10).attr("cy", 190).attr("r", 6).style("fill", "#74C476");
        svg.append("circle").attr("cx", 10).attr("cy", 220).attr("r", 6).style("fill", "#319450");
        svg.append("circle").attr("cx", 10).attr("cy", 250).attr("r", 6).style("fill", "#082E2E");
        ...
        svg.append("circle").attr("cx", 10).attr("cy", 130).attr("r", 6).style("fill", "#D0D3D4");
        svg.append("circle").attr("cx", 10).attr("cy", 160).attr("r", 6).style("fill", "#319450");
        svg.append("circle").attr("cx", 10).attr("cy", 190).attr("r", 6).style("fill", "#74C476");
        svg.append("circle").attr("cx", 10).attr("cy", 220).attr("r", 6).style("fill", "#082E2E");
        ...
        svg.append("circle").attr("cx", 10).attr("cy" ,130).attr("r", 6).style("fill", "#D0D3D4");
        svg.append("circle").attr("cx", 10).attr("cy", 160).attr("r", 6).style("fill", "#082E2E");
        svg.append("circle").attr("cx", 10).attr("cy", 190).attr("r", 6).style("fill", "#74C476");
        ...
        svg.append("circle").attr("cx", 10).attr("cy", 130).attr("r", 6).style("fill", "#082E2E");
        svg.append("circle").attr("cx", 10).attr("cy", 160).attr("r", 6).style("fill", "#EDF8E9");
        ...
        svg.append("circle").attr("cx", 10).attr("cy", 130).attr("r", 6).style("fill", "#EDF8E9");
        svg.append("circle").attr("cx", 10).attr("cy", 160).attr("r", 6).style("fill", "#74C476");
        svg.append("circle").attr("cx", 10).attr("cy", 190).attr("r", 6).style("fill", "#082E2E");
        ...
        svg.append("circle").attr("cx", 10).attr("cy", 130).attr("r", 6).style("fill", "#BAE4B3");
        svg.append("circle").attr("cx", 10).attr("cy", 160).attr("r", 6).style("fill", "#74C476");
        svg.append("circle").attr("cx", 10).attr("cy", 190).attr("r", 6).style("fill", "#082E2E");
        svg.append("circle").attr("cx", 10).attr("cy", 220).attr("r", 6).style("fill", "#EDF8E9");
        ...
        svg.append("circle").attr("cx", 10).attr("cy", 130).attr("r", 6).style("fill", "#74C476");
        svg.append("circle").attr("cx", 10).attr("cy", 160).attr("r", 6).style("fill", "#EDF8E9");
        svg.append("circle").attr("cx", 10).attr("cy", 190).attr("r", 6).style("fill", "#082E2E");
