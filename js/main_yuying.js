...
(function () {
    ...
    var attrArray = [
        ...
        "Acres_2018",
        "Acres_2019",
        "BurnProgra", // changed from BurnProgr to BurnProgra, make sure the attr names and the li ids are consistent
        "FireCounci",
        "LiabilityL",
        "Link",
        "PermitFee",
    ...
    var colorArrayProgram = [
        "#b3cde0", //Yes
        "#011f4b",
    ]; //No

    var colorArrayTrends = [
        "#b3cde0", //Down
        "#005b96", //Same
        "#011f4b",
    ]; //Up
    ...
    var colorArrayLaw = [
        "#6497b1", //Strict Liability
        "#005b96", //Simple Negligence
        "#03396c", //Gross Negligence
        "#011f4b",
    ]; //No Law

    var colorArrayPermit = [
        "#b3cde0", //Required
        "#011f4b",
    ]; //Not Required

    var colorArrayCouncil = [
        "#b3cde0", //Yes
        "#005b96", //No
        "#011f4b",
    ]; //Regional
    ...
    var attrcol = {
        ...
        BurnProgra: { Yes: "#b3cde0", No: "#011f4b" },
    ...
    function setMap() {
        ...
        var map = d3
            .select(".map") // class map in bootstrap column
            .append("svg")
            .attr("class", "map")
            .attr("width", width)
            .attr("height", height);
        ...
        function callback(data) {
            ...
            setEnumerationUnits(americanStates, map, path); // change colorize --> colorScale for more consistent language with D3 lab tutorial
    ...
    /*     function makeColorScale(data) {
        ...
        var colorScale = d3
            .scaleOrdinal() // sm: changed colorScale -->
